...
class Mage_Catalog_Model_Category extends Mage_Catalog_Model_Abstract
{
	...
	$attribute_code = Mage::app()->getRequest()->getParam('order');
	
	# Collection should be different based on parameter
	
	#echo "<p>Attribute Code: $attribute_code</p>";
	if($attribute_code=="price" or !$attribute_code)
	{
